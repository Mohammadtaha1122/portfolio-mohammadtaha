...
const Footer = () => {
  return (
    <div className="border-t border-t-gray-700 flex flex-col justify-center items-center pt-6">
  ...
  group-hover:scale-100 text-black"
      ...
      <div className="">
        <ul className="flex gap-15 my-10">
          <li>
            <Link
              className="pb-1 transition-all duration-300 ease-in-out outline-none hover:text-xl"
              href={"/"}
            >
              خانه
            </Link>
